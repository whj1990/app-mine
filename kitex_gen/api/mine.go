...
func (p *IdsInt64Params) InitDefault() {
	*p = IdsInt64Params{}
}
...
type SaveResponse struct {
	RowsAffected int64 `thrift:"rowsAffected,1" frugal:"1,default,i64" json:"rowsAffected"`
}
...
func (p *SaveResponse) InitDefault() {
	*p = SaveResponse{}
}
...
func (p *StatusParam) InitDefault() {
	*p = StatusParam{}
}
...
type ReviewProjectListParams struct {
	PageNum    int32  `thrift:"pageNum,1" frugal:"1,default,i32" json:"pageNum"`
	...
	ModeCode   string `thrift:"modeCode,5" frugal:"5,default,string" json:"modeCode"`
	Status     int8   `thrift:"status,6" frugal:"6,default,i8" json:"status"`
	ShowStatus int8   `thrift:"showStatus,7" frugal:"7,default,i8" json:"showStatus"`
}
...
func (p *ReviewProjectListParams) InitDefault() {
	*p = ReviewProjectListParams{}
}
...
type ReviewProjectData struct {
	...
	ModeCode    string `thrift:"modeCode,3" frugal:"3,default,string" json:"modeCode"`
	...
	Deleted     int8   `thrift:"deleted,6" frugal:"6,default,i8" json:"deleted"`
	CreatedUser string `thrift:"createdUser,7" frugal:"7,default,string" json:"createdUser"`
	UpdatedUser string `thrift:"updatedUser,8" frugal:"8,default,string" json:"updatedUser"`
	CreatedDate string `thrift:"createdDate,9" frugal:"9,default,string" json:"createdDate"`
	UpdatedDate string `thrift:"updatedDate,10" frugal:"10,default,string" json:"updatedDate"`
}
...
func (p *ReviewProjectData) InitDefault() {
	*p = ReviewProjectData{}
}
...
func (p *ReviewProjectSaveData) InitDefault() {
	*p = ReviewProjectSaveData{}
}
...
type ReviewProjectListResponse struct {
	...
	Data     []*ReviewProjectData `thrift:"data,4" frugal:"4,default,list<ReviewProjectData>" json:"data"`
}
...
func (p *ReviewProjectListResponse) InitDefault() {
	*p = ReviewProjectListResponse{}
}
...
type ReviewProjectDetailResponse struct {
	Data []*ReviewProjectData `thrift:"data,1" frugal:"1,default,list<ReviewProjectData>" json:"data"`
}
...
func (p *ReviewProjectDetailResponse) InitDefault() {
	*p = ReviewProjectDetailResponse{}
}
...
type ReviewProjectSaveParam struct {
	Action string                 `thrift:"action,1" frugal:"1,default,string" json:"action"`
	Data   *ReviewProjectSaveData `thrift:"data,2" frugal:"2,default,ReviewProjectSaveData" json:"data"`
}
...
func (p *ReviewProjectSaveParam) InitDefault() {
	*p = ReviewProjectSaveParam{}
}
...
type AppMineReviewProjectListArgs struct {
	Req *ReviewProjectListParams `thrift:"req,1" frugal:"1,default,ReviewProjectListParams" json:"req"`
}
...
func (p *AppMineReviewProjectListArgs) InitDefault() {
	*p = AppMineReviewProjectListArgs{}
}
...
type AppMineReviewProjectListResult struct {
	Success *ReviewProjectListResponse `thrift:"success,0,optional" frugal:"0,optional,ReviewProjectListResponse" json:"success,omitempty"`
}
...
func (p *AppMineReviewProjectListResult) InitDefault() {
	*p = AppMineReviewProjectListResult{}
}
...
type AppMineReviewProjectDetailsArgs struct {
	Req *IdsInt64Params `thrift:"req,1" frugal:"1,default,IdsInt64Params" json:"req"`
}
...
func (p *AppMineReviewProjectDetailsArgs) InitDefault() {
	*p = AppMineReviewProjectDetailsArgs{}
}
...
type AppMineReviewProjectDetailsResult struct {
	Success *ReviewProjectDetailResponse `thrift:"success,0,optional" frugal:"0,optional,ReviewProjectDetailResponse" json:"success,omitempty"`
}
...
func (p *AppMineReviewProjectDetailsResult) InitDefault() {
	*p = AppMineReviewProjectDetailsResult{}
}
...
type AppMineReviewProjectSaveArgs struct {
	Req *ReviewProjectSaveParam `thrift:"req,1" frugal:"1,default,ReviewProjectSaveParam" json:"req"`
}
...
func (p *AppMineReviewProjectSaveArgs) InitDefault() {
	*p = AppMineReviewProjectSaveArgs{}
}
...
type AppMineReviewProjectSaveResult struct {
	Success *SaveResponse `thrift:"success,0,optional" frugal:"0,optional,SaveResponse" json:"success,omitempty"`
}
...
func (p *AppMineReviewProjectSaveResult) InitDefault() {
	*p = AppMineReviewProjectSaveResult{}
}
...
type AppMineReviewProjectStatusArgs struct {
	Req *StatusParam `thrift:"req,1" frugal:"1,default,StatusParam" json:"req"`
}
...
func (p *AppMineReviewProjectStatusArgs) InitDefault() {
	*p = AppMineReviewProjectStatusArgs{}
}
...
func (p *AppMineReviewProjectStatusResult) InitDefault() {
	*p = AppMineReviewProjectStatusResult{}
}
...
type AppMineReviewProjectDeleteArgs struct {
	Req *IdParam `thrift:"req,1" frugal:"1,default,IdParam" json:"req"`
}
...
func (p *AppMineReviewProjectDeleteArgs) InitDefault() {
	*p = AppMineReviewProjectDeleteArgs{}
}
...
func (p *AppMineReviewProjectDeleteResult) InitDefault() {
	*p = AppMineReviewProjectDeleteResult{}
}
