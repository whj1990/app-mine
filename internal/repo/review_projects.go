...
type ReviewProjectRepo interface {
	List(context.Context, *api.ReviewProjectListParams) (*[]ReviewProjectData, int64, error)
	...
	UpdateStatus(context.Context, *api.StatusParam) (int64, error)
}
...
func (r *reviewProjectRepo) List(ctx context.Context, req *api.ReviewProjectListParams) (*[]ReviewProjectData, int64, error) {
	var count int64
...
func (r *reviewProjectRepo) UpdateStatus(ctx context.Context, req *api.StatusParam) (count int64, err error) {
	userName, err := util.GetMetaInfoCurrentUserName(ctx)
	if err != nil {
		return 0, err
	}
